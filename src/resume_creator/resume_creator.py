...
def create_resume(resume_chat_gpt, user):
    ...
    run = subheading_paragraph.add_run(subheading)
    run.bold = True
    run.font.size = Pt(14)

    education = text_extraction.extract_text_between_keywords(resume_chat_gpt, "Education:", "Work Experiences:")
    work_experience = text_extraction.extract_text_between_keywords(resume_chat_gpt, "Work Experiences:", "Skills:")
    skills = text_extraction.extract_text_between_keywords(resume_chat_gpt, "Skills:", "END")
